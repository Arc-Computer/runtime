...
class MCPInterceptor(BaseInterceptor):
    ...
    def _patch_httpx(self):
        ...
        def patched_sync_request(client_self, method: str, url, **kwargs):
            ...
            return interceptor._original_httpx_request(client_self, method, url, **kwargs)
        ...
        async def patched_async_request(client_self, method: str, url, **kwargs):
            ...
            # Not an MCP call, proceed normally
            return await interceptor._original_httpx_async_request(client_self, method, url, **kwargs)
    ...
    def _extract_mcp_metadata(self, url: str, method: str, headers: Dict[str, str], kwargs: Dict[str, Any]) -> Dict[str, Any]:
